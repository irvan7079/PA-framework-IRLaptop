...
<div class="flex">
    ...
    <div class="w-2/5 h-screen bg-violet-950 flex justify-center items-center">
        <div class="absolute w-2/5 h-auto right-24 bg-gray-900 rounded-xl flex flex-col overflow-hidden divide-y-2">
            ...
            <div class="h-full px-12 py-8 flex flex-col justify-between items-center">
                <form action="{{ route('register.action') }}" method="post" class="w-full flex flex-col items-start">
                    ...
                    <div class="w-full relative mt-6">
                        ...
                        <input type="username" name="username" placeholder="Username" class="w-full ps-12 pe-4 py-2 bg-gray-800 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-violet-500">
                    </div>
                    <div class="w-full relative mt-6">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                            <svg class="h-6 fill-slate-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                        ...
                        <input type="password" name="password" placeholder="Password" class="w-full ps-12 pe-4 py-2 bg-gray-800 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-violet-500">
                    </div>
                    <div class="w-full relative mt-6">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                            <svg class="h-6 fill-slate-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                        ...
                        <input type="password" name="confirm_password" placeholder="Confirm Password" class="w-full ps-12 pe-4 py-2 bg-gray-800 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-violet-500">
                    </div>
