    ...
    <div class="container min-h-screen ] bg-cover px-24 py-5 relative" >
        <nav class="flex text-center">
            ...
            <ul class="flex-1 items-center">
                ...
                <li class="list-none inline-block px-5"><a href="#"  class="no-underline text-white px-2">Review</a></li>
        ...
        <div class="text-white mt-48">
            ...
            <div class="mt-10">
                <a href="" class="bg-violet-950 rounded-3xl py-3 px-8 font-medium inline-block mr-4
